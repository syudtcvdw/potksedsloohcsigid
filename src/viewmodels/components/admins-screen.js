const vm = function (params) {
	...
	vm.adminDetails = ko.observableArray([
		{ sn: 1, name: 'Victor I. Afolabi', email: 'victor@vic.com', action: 'remove' },
		{ sn: 2, name: 'Banjo Mofesola Paul', email: 'depaule@paul.com', action: 'remove' },
		{ sn: 3, name: 'Dotun Longe', email: 'dedean@beats.net', action: 'remove' }
	])
